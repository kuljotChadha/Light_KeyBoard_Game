...
function updateParagraph() {
    document.getElementById("p1").innerHTML = "Select buttons in the  order as they appear to win.\nCurrent Score: "+curScore+" | High Score: "+highScore;
}
function clearTimer() {
  clearTimeout(timer);
  timeRemaining = 0;
...
function updateTimer() {
    if (timeRemaining >= 0) {
      document.getElementById("p2").innerHTML = "Time remaining to Answer: " + timeRemaining;
      timeRemaining--;
    } else {
      loseGame();
    }
